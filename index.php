...
<html lang="es">
	<head>
		<meta charset="UTF-8">
		<title>[Martin Eduardo Elias Menjivar EM101111]</title>
				...
				<div class="row align-items-center h-100">
					...
					<div class="col">
						<div class="align-items-center">
							<p>[Martin Eduardo Elias Menjivar EM101111]</p>
...
window.location.replace(datos.data.url+"?toke="+datos.data.token);
}).fail(function(xhr,status,error){
	$(".mensaje").html(hrx.responseJSON.error.message)
});
}
...
$(document).ready(function(){
	...
	$("txt_usuario").keypress(function(event){
		//SE EVALUA SI LA TECLA ES "ENTER" 
		if(event.which == 13){
			//SE EJECUTA LA FUNCION enviar_datos()
			enviar_datos($("#txt_usuario"),$("#txt_password"));
		}
